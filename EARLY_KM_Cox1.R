...
#------------------------------------------------------------
data_tavr <- read_csv("Input/EARLY_TAVR1.csv", col_names = c("time", "incidence"),
...
#------------------------------------------------------------
ipd_tavr <- simulate_ipd_with_risk(data_tavr, at_risk_tavr, time_points, N_tavr, "int")
...
summary(ipd_all)
saveRDS(ipd_all, "Output/Early_km.rds")
#------------------------------------------------------------
