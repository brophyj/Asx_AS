...
#------------------------------------------------------------
data_int <- read_csv("Input/EVOLVED_Sx.csv", col_names = c("time", "incidence"),
                     show_col_types = FALSE) # Adds column names time and incidence (%)
data_clinical <- read_csv("Input/EVOLVED_Ctl.csv", col_names = c("time", "incidence"),
                          show_col_types = FALSE) # Adds column names time and incidence (%)
...
saveRDS(ipd_all, "Output/EVOLVED_km.rds")
#------------------------------------------------------------
